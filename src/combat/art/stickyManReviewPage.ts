...
const ROWS: ReviewRow[] = [
  ...
  { label: 'Jab 1 (light)', frames: POSES_PALM_ATTACK_1, palette: PALETTE_HERO, variant: 'hero' },
  { label: 'Jab 2 (cross)', frames: POSES_PALM_ATTACK_2, palette: PALETTE_HERO, variant: 'hero' },
  { label: 'Heavy haymaker', frames: POSES_HEAVY_HAYMAKER, palette: PALETTE_HERO, variant: 'hero' },
  { label: 'Heavy uppercut', frames: POSES_HEAVY_UPPERCUT, palette: PALETTE_HERO, variant: 'hero' },
  { label: 'Heavy body blow', frames: POSES_HEAVY_BODY, palette: PALETTE_HERO, variant: 'hero' },
