...
| 7 | ~~Procedural **settlement clusters + signature tree** per `worldProfile`~~ | 06, 21, 22 | `[x]` Done 2026-07-10, all 11 profiles authored 2026-07-11 — `ProceduralSettlementGenerator` + `SettlementDecorator`; every `world.*.json` (fallen_village + gate, ch2–10) now has authored `settlements[]`/`signatureTree` matching `map-design-canon.md` §4.3 roster |
...
| Preset SFX; crit + duck; per-map Fallen Village BGM | |
...
| **Music + SFX volume sliders** (2026-07-11) — `SettingsModal` now has all three (Music/SFX/UI) | |
